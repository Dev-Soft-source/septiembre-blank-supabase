...
export function AnimatedSlogansGroupA() {
  const { t } = useTranslation('ui');
  const items = [t('leaders.slogans.1'), t('leaders.slogans.2'), t('leaders.slogans.3')];
  ...
  return (
    <section ref={sectionRef as any} className="min-h-screen grid place-items-center relative">
      <div className="text-center max-w-5xl px-4 relative z-10">
        {/* Measurement container to avoid layout jump */}
