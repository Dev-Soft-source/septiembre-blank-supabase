-- Add missing hotel feature translations for raw database keys
INSERT INTO filter_value_mappings (category, english_value, spanish_value, portuguese_value, romanian_value, is_active) VALUES
-- Hotel Features (raw database keys)
('hotel_features', 'Wifi', 'WiFi', 'WiFi', 'WiFi', true),
...
('hotel_features', 'Pool', 'Piscina', 'Piscina', 'Piscină', true),
('hotel_features', 'Restaurant', 'Restaurante', 'Restaurante', 'Restaurant', true),
('hotel_features', 'Gym', 'Gimnasio', 'Academia', 'Sală de sport', true),
('hotel_features', 'Bar', 'Bar', 'Bar', 'Bar', true),
('hotel_features', 'Spa', 'Spa', 'Spa', 'Spa', true),
('hotel_features', 'Garden', 'Jardín', 'Jardim', 'Grădină', true),
('hotel_features', 'Terrace', 'Terraza', 'Terraço', 'Terasă', true),
...
('hotel_features', 'Parking', 'Parking', 'Estacionamento', 'Parcare', true),
('hotel_features', 'Elevator', 'Ascensor', 'Elevador', 'Lift', true),
...
-- Room Features (raw database keys)
...
('room_features', 'TV', 'TV', 'TV', 'TV', true),
('room_features', 'WiFi', 'WiFi', 'WiFi', 'WiFi', true),
('room_features', 'Minibar', 'Minibar', 'Minibar', 'Minibar', true),
('room_features', 'Safe', 'Caja fuerte', 'Cofre', 'Seif', true),
('room_features', 'Hair_dryer', 'Secador de pelo', 'Secador de cabelo', 'Uscător de păr', true),
...
('room_features', 'Balcony', 'Balcón', 'Varanda', 'Balcon', true),
('room_features', 'Kitchen', 'Cocina', 'Cozinha', 'Bucătărie', true),
('room_features', 'Refrigerator', 'Frigorífico', 'Geladeira', 'Frigider', true),
('room_features', 'Microwave', 'Microondas', 'Micro-ondas', 'Cuptor cu microunde', true),
('room_features', 'Dishwasher', 'Lavavajillas', 'Lava-louças', 'Mașină de spălat vase', true),
('room_features', 'Wardrobe', 'Armario', 'Guarda-roupa', 'Dulap', true),
('room_features', 'Workspace', 'Zona de trabajo', 'Espaço de trabalho', 'Spațiu de lucru', true),
('room_features', 'Sofa', 'Sofá', 'Sofá', 'Canapea', true),
('room_features', 'Sea_view', 'Vistas al mar', 'Vista para o mar', 'Vedere la mare', true),
('room_features', 'Mountain_view', 'Vistas a la montaña', 'Vista para a montanha', 'Vedere la munte', true),
('room_features', 'Garden_view', 'Vistas al jardín', 'Vista para o jardim', 'Vedere la grădină', true),
('room_features', 'Shower', 'Ducha', 'Chuveiro', 'Duș', true),
('room_features', 'Bathtub', 'Bañera', 'Banheira', 'Cadă', true)

ON CONFLICT (category, english_value) DO UPDATE SET
