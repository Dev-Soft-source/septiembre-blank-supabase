...
-- Drop and recreate views to fix column ordering issues
...
-- Update sensitive data function to only return truly sensitive business information
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'changes', ARRAY[
      ...
      'Made public rates and pricing matrices visible for booking',
    ...
    'business_requirement', 'Prices must be public for booking and business model functionality',
