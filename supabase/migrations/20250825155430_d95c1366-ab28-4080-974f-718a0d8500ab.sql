...
-- Update hotel_images table with new main images
UPDATE hotel_images 
...
-- Add hotel_images entries for the other two hotels if they don't have main images
INSERT INTO hotel_images (hotel_id, image_url, is_main, display_order)
VALUES 
('984d2175-8f38-439f-af06-052ef8d3f24a', '/assets/hotel-images/south-austin-lodge-unique.jpg', true, 1),
('4c444701-8318-4d7a-adb7-c2bf719f9388', '/assets/hotel-images/bluegrass-inn-unique.jpg', true, 1)
ON CONFLICT (hotel_id, display_order) DO UPDATE 
SET image_url = EXCLUDED.image_url, is_main = EXCLUDED.is_main;