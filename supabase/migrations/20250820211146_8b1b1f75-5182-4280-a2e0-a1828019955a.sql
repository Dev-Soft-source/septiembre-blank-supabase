-- Add meal_plan column to availability_packages and update pricing to match the star rating tables

-- First, add the meal_plan column
...
-- Using the pricing tables provided: 3-star, 4-star, and 5-star hotels
...
BEGIN
  ...
  LOOP
    -- Calculate price based on category, duration, and meal plan
    -- Default to half_board if meal_plan is null
    new_price := CASE 
      -- 3-STAR HOTELS
        ...
        CASE package_record.duration_days
          WHEN 8 THEN
            CASE COALESCE(package_record.meal_plan, 'half_board')
              ...
              ELSE 800 -- default to half_board
            END
          WHEN 15 THEN
            CASE COALESCE(package_record.meal_plan, 'half_board')
              ...
              ELSE 640 -- default to half_board
            END
          WHEN 22 THEN
            CASE COALESCE(package_record.meal_plan, 'half_board')
              ...
              ELSE 440 -- default to half_board
            END
          WHEN 29 THEN
            CASE COALESCE(package_record.meal_plan, 'half_board')
              ...
              ELSE 240 -- default to half_board
            END
          ELSE 800 -- default for unknown durations
        END
        ...
        CASE package_record.duration_days
          WHEN 8 THEN
            CASE COALESCE(package_record.meal_plan, 'half_board')
              ...
              ELSE 1280 -- default to half_board
            END
          WHEN 15 THEN
            CASE COALESCE(package_record.meal_plan, 'half_board')
              ...
              ELSE 960 -- default to half_board
            END
          WHEN 22 THEN
            CASE COALESCE(package_record.meal_plan, 'half_board')
              WHEN 'room_only' THEN 320
          ...
          WHEN 29 THEN
            CASE COALESCE(package_record.meal_plan, 'half_board')
              ...
              ELSE 340 -- default to half_board
            END
          ELSE 1280 -- default for unknown durations
        END
        ...
        CASE package_record.duration_days
          WHEN 8 THEN
            CASE COALESCE(package_record.meal_plan, 'half_board')
              ...
              ELSE 2760 -- default to half_board
            END
          WHEN 15 THEN
            CASE COALESCE(package_record.meal_plan, 'half_board')
              WHEN 'room_only' THEN 640
          ...
          WHEN 22 THEN
            CASE COALESCE(package_record.meal_plan, 'half_board')
              ...
              ELSE 880 -- default to half_board
            END
          WHEN 29 THEN
            CASE COALESCE(package_record.meal_plan, 'half_board')
              ...
              ELSE 480 -- default to half_board
            END
          ELSE 2760 -- default for unknown durations
        END
    ...
    RAISE LOG 'Updated package % with price %', package_record.id, new_price;
    
  END LOOP;
  
  RAISE LOG 'Completed pricing update for all availability packages';
END $$;