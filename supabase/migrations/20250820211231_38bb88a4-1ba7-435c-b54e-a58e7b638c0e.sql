-- First, let me check and disable the price cap constraint
-- Drop the trigger that enforces price caps
DROP TRIGGER IF EXISTS enforce_price_caps_trigger ON availability_packages;

-- Drop the function that enforces price caps
DROP FUNCTION IF EXISTS enforce_price_caps();
