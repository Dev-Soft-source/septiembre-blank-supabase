...
-- Since we can't create fake profiles, let's make hotels work without profile_id temporarily
-- by changing the NOT NULL constraint temporarily for demo data
ALTER TABLE hotels ALTER COLUMN profile_id DROP NOT NULL;

-- Insert demo hotels directly using UUIDs for the various IDs
DO $$
DECLARE
...
BEGIN
  ...
  FOR i IN 1..10 LOOP
    INSERT INTO hotels (
      name, description, city, country_id, address, 
    ...
    -- Add availability package (using valid duration values: 8, 15, 22, 29)
    INSERT INTO availability_packages (hotel_id, start_date, duration, rooms, base_price, duration_days, base_price_usd)
    VALUES (new_hotel_id, '2024-01-01', 29, 10, 1200 + (i * 100), 29, 1200 + (i * 100));
  END LOOP;
  ...
  FOR i IN 11..18 LOOP
    ...
    IF wellness_affinity_id IS NOT NULL THEN
      INSERT INTO hotel_affinities (hotel_id, affinity_id) VALUES (new_hotel_id, wellness_affinity_id);
    END IF;
    IF nature_affinity_id IS NOT NULL THEN
    ...
    INSERT INTO availability_packages (hotel_id, start_date, duration, rooms, base_price, duration_days, base_price_usd)
    VALUES (new_hotel_id, '2024-01-01', 22, 8, 1100 + ((i-10) * 80), 22, 1100 + ((i-10) * 80));
  END LOOP;
  ...
  FOR i IN 19..28 LOOP
    ...
    IF wine_activity_id IS NOT NULL THEN
      INSERT INTO hotel_activities (hotel_id, activity_id) VALUES (new_hotel_id, wine_activity_id);
    END IF;
    IF cooking_activity_id IS NOT NULL THEN
      INSERT INTO hotel_activities (hotel_id, activity_id) VALUES (new_hotel_id, cooking_activity_id);
    END IF;
    IF gastronomy_affinity_id IS NOT NULL THEN
      INSERT INTO hotel_affinities (hotel_id, affinity_id) VALUES (new_hotel_id, gastronomy_affinity_id);
    END IF;
    IF luxury_affinity_id IS NOT NULL THEN
      INSERT INTO hotel_affinities (hotel_id, affinity_id) VALUES (new_hotel_id, luxury_affinity_id);
    END IF;
    IF culture_affinity_id IS NOT NULL THEN
    ...
    INSERT INTO availability_packages (hotel_id, start_date, duration, rooms, base_price, duration_days, base_price_usd)
    VALUES (new_hotel_id, '2024-01-01', 15, 12, 1500 + ((i-18) * 120), 15, 1500 + ((i-18) * 120));
  END LOOP;
  ...
  FOR i IN 29..36 LOOP
    ...
    INSERT INTO availability_packages (hotel_id, start_date, duration, rooms, base_price, duration_days, base_price_usd)
    VALUES (new_hotel_id, '2024-01-01', 8, 10, 1400 + ((i-28) * 110), 8, 1400 + ((i-28) * 110));
  END LOOP;
  ...
  FOR i IN 37..42 LOOP
    ...
    INSERT INTO availability_packages (hotel_id, start_date, duration, rooms, base_price, duration_days, base_price_usd)
    VALUES (new_hotel_id, '2024-01-01', 22, 8, 1300 + ((i-36) * 100), 22, 1300 + ((i-36) * 100));
  END LOOP;
  ...
  FOR i IN 43..46 LOOP
    ...
    INSERT INTO availability_packages (hotel_id, start_date, duration, rooms, base_price, duration_days, base_price_usd)
    VALUES (new_hotel_id, '2024-01-01', 29, 12, 1600 + ((i-42) * 150), 29, 1600 + ((i-42) * 150));
  END LOOP;
