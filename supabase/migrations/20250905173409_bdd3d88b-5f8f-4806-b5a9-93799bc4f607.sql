-- Update the handle_new_user function to call admin notification
...
BEGIN
  ...
  BEGIN
    ...
    -- Call admin notification edge function directly  
    PERFORM
      net.http_post(
        url := 'https://zlzsnpkddpshdyjlwxzv.supabase.co/functions/v1/notify-admin-registration',
        headers := '{"Content-Type": "application/json", "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InpsenNucGtkZHBzaGR5amx3eHp2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NjgzNTIxOCwiZXhwIjoyMDcyNDExMjE4fQ.BE-7rCg3jP_06AtJY6OBEQ7xH-Yx9JJLmJutgNyDJH0"}',
