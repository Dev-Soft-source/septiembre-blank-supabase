...
BEGIN
  ...
  ELSE
    RAISE WARNING 'ISSUE: Expected % packages but created %, % hotels have exactly 2 packages', total_hotels * 2, total_packages, hotels_with_2_packages;
  END IF;
END $$;