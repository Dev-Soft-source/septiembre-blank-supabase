-- Fix RLS policies for hotel filtering (corrected version)
...
-- 4. Create simple indexes for better performance
CREATE INDEX IF NOT EXISTS idx_hotel_themes_hotel_id ON hotel_themes(hotel_id);
CREATE INDEX IF NOT EXISTS idx_hotel_activities_hotel_id ON hotel_activities(hotel_id);
