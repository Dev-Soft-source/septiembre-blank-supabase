...
-- Revert hotels_public view (simplified without reviews)
...
-- Revert hotels_public_view (simplified without reviews)
...
-- Revert hotels_with_filters_view (simplified without reviews)  
...
-- Revert hotels_detailed_view (simplified without reviews)
